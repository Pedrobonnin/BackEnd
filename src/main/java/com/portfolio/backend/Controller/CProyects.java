...
import com.portfolio.backend.Dto.dtoProyects;
import com.portfolio.backend.Entity.Proyect;
import com.portfolio.backend.Security.Controller.Mensaje;
import com.portfolio.backend.Service.SProyects;
...
public class CProyects {
   @Autowired SProyects sProyects;
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyects dtoproyects) {
        ...
        Proyect proyecto = new Proyect(dtoproyects.getNameProy(), dtoproyects.getDetailsProy(), dtoproyects.getRepoUrlProy(), dtoproyects.getSiteUrlProy(), dtoproyects.getImgUrlProy(), dtoproyects.getToolsProy());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyects dtoproyects) {
        ...
        proyecto.setRepoUrlProy(dtoproyects.getRepoUrlProy());
        proyecto.setSiteUrlProy(dtoproyects.getSiteUrlProy());
        proyecto.setImgUrlProy(dtoproyects.getImgUrlProy());
        proyecto.setToolsProy(dtoproyects.getToolsProy());
