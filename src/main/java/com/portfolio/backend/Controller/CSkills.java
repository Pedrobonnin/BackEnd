...
public class CSkills {
    ...
    public ResponseEntity<?> create(@RequestBody dtoSkills dtoskill) {
        ...
        Skills skill = new Skills(dtoskill.getUnaSkill(), dtoskill.getPorcentaje(), dtoskill.getOuterStrokeColor());
        sSkills.save(skill);
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoSkills dtoskill) {
        ...
        skill.setOuterStrokeColor(dtoskill.getOuterStrokeColor());
        sSkills.save(skill);
